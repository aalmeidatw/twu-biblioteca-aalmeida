...
public class BookList {
    private ArrayList<Book> myBookList = new ArrayList<>();
     ...
     public ArrayList<Book> createBookList(){
        ...
        Book book2 = new Book(new BookName("Ulysses"),new AuthorName("James Joyce"), new PublicationYear(1904), true);
        ...
        Book book5 = new Book(new BookName("War And Peace"),new AuthorName("Leo TolStoy"), new PublicationYear(1873), false);
